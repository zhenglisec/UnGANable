...
class OptimInversion():
    ...
    def invert_5000(self, dataloader, save_path, init_code=None):
        ...
        np.save(save_path + '/opt_rec_100.npy', results)

        results = {'IMGS': IMGS_500, 'CODES': CODES_500}
        np.save(save_path + '/opt_rec_500.npy', results)

        results = {'IMGS': IMGS_1000, 'CODES': CODES_1000}
        np.save(save_path + '/opt_rec_1000.npy', results)

        results = {'IMGS': IMGS_1500, 'CODES': CODES_1500}
        np.save(save_path + '/opt_rec_1500.npy', results)

        results = {'IMGS': IMGS_2000, 'CODES': CODES_2000}
        np.save(save_path + '/opt_rec_2000.npy', results)

        results = {'IMGS': IMGS_2500, 'CODES': CODES_2500}
        np.save(save_path + '/opt_rec_2500.npy', results)

        results = {'IMGS': IMGS_3000, 'CODES': CODES_3000}
        np.save(save_path + '/opt_rec_3000.npy', results)

        results = {'IMGS': IMGS_3500, 'CODES': CODES_3500}
        np.save(save_path + '/opt_rec_3500.npy', results)

        results = {'IMGS': IMGS_4000, 'CODES': CODES_4000}
        np.save(save_path + '/opt_rec_4000.npy', results)

        results = {'IMGS': IMGS_4500, 'CODES': CODES_4500}
        np.save(save_path + '/opt_rec_4500.npy', results)

        results = {'IMGS': IMGS_5000, 'CODES': CODES_5000}
        np.save(save_path + '/opt_rec_5000.npy', results)
